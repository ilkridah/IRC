...
namespace IRCReplay {
    ...
    void RPL_NAMREPLY(Client& client, std::string const& channelname, ChannelHandler& channels) {
        std::pair<bool, std::vector<std::string> > userlist_res = channels.get_users(channelname);
